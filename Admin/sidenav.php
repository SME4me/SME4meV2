     ...
     <div id="navigation">
         ...
         <ul class="navigation-menu">
             <li class="has-submenu">
                 ...
                 <ul class="submenu">
                     <li>
                         <a href="index-2.html">Dashboard 01</a>
                     </li>
                     <li>
             ...
             <li class="has-submenu">
                 <a href="#"><i class="md md-color-lens"></i>Opportunities</a>
                 <ul class="submenu">
                    <li class="<?php echo isActive('startup', $page_name); ?>"><a href="dashboard_3.html">Start Ups</a></li>
                    <li class="<?php echo isActive('esseys', $page_name); ?>"><a href="dashboard_3.html">Esseys</a></li>
